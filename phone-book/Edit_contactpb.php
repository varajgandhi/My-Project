	   ...
	   $conn= new mysqli("localhost", "root", "","phonebook");
		if($filetype=='image/jpeg' or $filetype=='image/png' or $filetype=='image/gif')
		{
			...
			move_uploaded_file($_FILES["image"]["tmp_name"],"$folder".$_FILES["image"]["name"]);	
	   		...
	   		if(!$result)
	   		{
		   	 		$msg="<span style='color:lightgreen;'>Contact Updated Successfully</span>";
...
<body class="my_body">
     ...
     <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method='POST' enctype="multipart/form-data" ><br/>
			 ...
			 <input type="submit" value="Update" name="Submit" /> <input type="button" id="button" value="Home" onclick="window.location.href='Controlpb.php'" />
